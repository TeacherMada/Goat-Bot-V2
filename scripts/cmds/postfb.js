...
module.exports = {
  ...
  onStart: async function ({ event, api, commandName }) {
    ...
    return api.sendMessage(`Choisissez une audience qui peut voir votre article\n1. Tout le monde\n2. Amis\n3. Moi uniquement`, threadID, (e, info) => {
  ...
  onReply: async function ({ Reply, event, api, commandName }) {
    ...
    if (type == "whoSee") {
      ...
      api.unsendMessage(handleReply.messageID, () => {
        api.sendMessage(`🔘 Ataovy répondre ity message ity, ary soraty ny DESCRIPTIONS_(texte).\n\n🔘 Raha tsy asiana Descriptions_(0) kosa dia soraty: 0`, threadID, (e, info) => {
          global.GoatBot.onReply.set(info.messageID, {
            commandName,
            messageID: info.messageID,
            author: author,
      ...
      api.unsendMessage(handleReply.messageID, () => {
        api.sendMessage(`🔘 Ataovy répondre ity message ity, avieo Upload IMAGE / VIDÉO.\n\n🔘 Raha tsy asiana Fichiers-Attechement_(0) kosa dia soraty: 0`, threadID, (e, info) => {
          global.GoatBot.onReply.set(info.messageID, {
            commandName,
            messageID: info.messageID,
            author: author,
